...
int main(int argc, char **argv)
{
    ...
    */
    ...
    sql = "INSERT INTO sensores (SENSOR, MINIMO, PROMEDIO, MAXIMO, FECHA) " \
          "VALUES ('Temperatura', " + to_string(minTemp) + ", " + to_string(promTemp) + ", " + to_string(maxTemp) + ", '" + fecha + "'); " \
          "INSERT INTO sensores (SENSOR, MINIMO, PROMEDIO, MAXIMO, FECHA) " \
          "VALUES ('Humedad', " + to_string(minHum) + ", " + to_string(promHum) + ", " + to_string(maxHum) + ", '" + fecha + "'); " \
          "INSERT INTO sensores (SENSOR, MINIMO, PROMEDIO, MAXIMO, FECHA) " \
          "VALUES ('Velocidad', " + to_string(minVel) + ", " + to_string(promVel) + ", " + to_string(maxVel) + ", '" + fecha + "'); " \
          "INSERT INTO sensores (SENSOR, MINIMO, PROMEDIO, MAXIMO, FECHA) " \
          "VALUES ('Viento', " + to_string(minViento) + ", " + to_string(promViento) + ", " + to_string(maxViento) + ", '" + fecha + "'); " \
          "INSERT INTO sensores (SENSOR, MINIMO, PROMEDIO, MAXIMO, FECHA) " \
          "VALUES ('Precipitacion', " + to_string(minPrec) + ", " + to_string(promPrec) + ", " + to_string(maxPrec) + ", '" + fecha + "'); " \
          "INSERT INTO sensores (SENSOR, MINIMO, PROMEDIO, MAXIMO, FECHA) " \
          "VALUES ('Luz', " + to_string(minLuz) + ", " + to_string(promLuz) + ", " + to_string(maxLuz) + ", '" + fecha + "'); ";
